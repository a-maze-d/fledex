...
## Bugs
- [ ] It looks like the offset can in some circumstances be zero and in others it can not. It's not consistent. Also for animations it's easier if the offset is allowed to be zero. (0.8)
