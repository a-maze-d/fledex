defmodule Fledex.FunctionsTest do
  ...
  describe "test rainbow function" do
    ...
    test "check no correction" do
      correction = Correction.define_correction(255, uncorrected_color(), uncorrected_temperature())
    ...
    test "check scale correction" do
      correction = Correction.define_correction(200, uncorrected_color(), uncorrected_temperature())
