...
defmodule Fledex.Color.KinoRenderTest do
  ...
  describe "conversion functions" do
    ...
    test "to_markdown" do
      kino = KinoRender.new([0x0000ff, {0, 0, 255}])
      assert ~s(<span style="color: #0000FF">█</span><span style="color: #0000FF">█</span>) == KinoRender.to_markdown(kino)
    end
  end
  describe "livebook" do
    test "render" do
      ...
      assert_output(%{
        ...
        %{
          type: :terminal_text,
          text: ~s(%Fledex.Color.KinoRender{\e[34mcolors:\e[0m [\e[34m16711680\e[0m, \e[34m65280\e[0m, \e[34m255\e[0m]}),
          chunk: false
        }],
        type: :tabs
      })
