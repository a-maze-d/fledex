...
defmodule Fledex.Color.ColorTest do
  ...
  describe "RGB tests" do
    test "new" do
      assert %RGB{r: 0xFF, g: 0xEE, b: 0xDD} = RGB.new({0xFF, 0xEE, 0xDD})
      ...
      assert {0xFF, 0xEE, 0xDD} = RGB.new(0xFFEEDD) |> RGB.to_tuple()
      assert {0xFF, 0xEE, 0xDD} = {0xFF, 0xEE, 0xDD} |> RGB.to_tuple()
